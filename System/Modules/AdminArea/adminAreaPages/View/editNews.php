    ...
    <form id="editorForm" method="post" enctype="multipart/form-data">
        <div class="curse open_curse design" style="display: block; ">
            <table style="width: 100%;">
                <tr>
                    <td width="80">
                        <img src="<?php echo $layout->draw()->image('news', $id, true) ?>" width="66" height="66" border="0" alt="" style="border:1px gray solid; border-radius:3px; padding:3px; margin: 0 5px 2px 0;   background: none repeat scroll 0 0 #FFFFFF;">
                    </td>
                    <td>
                    ...
                    <td align="right">
                        <a href="/adminArea/pages/news" class="button">Назад</a>
                    </td>
                </tr>
            </table>
